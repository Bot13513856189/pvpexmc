...
client.on('message', msg => {  //WESO#0001
    if (msg.content === 'ip') {  //WESO#0001
      msg.reply('** :wink: PvPExmc.aternos.me   :sparkling_heart:**');  //WESO#0001
    }
  });

client.on('message', msg => {  //WESO#0001
    if (msg.content === 'سلام عليكم') {  //WESO#0001
      msg.reply('**و عليكم السلام**');  //WESO#0001
    }
  });
...
client.on('ready', function(){
    var ms = 10000 ;
    var setGame = [' -help',`PvPex Ststem`,`Hello Im PvPex Bot `,' Need Help Type : -help ','PvPExmc.aternos.me'];
    var i = -1;
    var j = 0;
